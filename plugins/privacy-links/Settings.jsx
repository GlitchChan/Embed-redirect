...
export default dependPersist(() => (
  <>
    ...
    <SSwitch k={"invidiousChangeSentLinks"} depends={"enableInvidious"}>
      Change Sent Links
    </SSwitch>
    <SSwitch k={"invidiousChangeExistingMessages"} depends={"enableInvidious"}>
      Change YouTube Embeds
    </SSwitch>
    <SSelect
      k={"invidiousInstance"}
    ...
    >
      Invidious Instance (You may have to reload for this to fully take effect)
    </SSelect>

    {/*Twitter Options*/}
    <SSwitch k={"enableTwit"}>Enable Twitter Redirects</SSwitch>
    <SSwitch k={"twitFixChangeSentLinks"} depends={"enableTwit"}>
      Change Sent Links
    </SSwitch>
    <SSelect
      k={"twitFixInstance"}
